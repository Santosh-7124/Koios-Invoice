...
import DeliveryChallanKESLayout from "./DeliveryChallanKESLayout";

function DeliveryChallanKES() {
  // State declarations
  ...
  return (
    <>
     <Helmet>
        ...
        <title>KES Delivery Challan</title>
      </Helmet>
      <div>
          ...
          <div className="formContainer">
            <div className="formSection">
              ...
              <div className="formSubSection">
                ...
                <div className="formInputDiv">
                  <label htmlFor="placeOfSupply">DC Type</label>
                  <input
                    type="text"
                    id="placeOfSupply"
                    name="placeOfSupply"
            ...
            <div className="formSection">
              ...
              <div className="formSubSection">
                <div className="formInputDiv">
                  <label htmlFor="shippedToCompany">
                    Company<span>*</span>{" "}
                  </label>
                  <input
                    required
            ...
            <div className="formSection">
              <div className="formSectionHeading">Terms & Conditions</div>
        ...
        <div id="yourFormId" style={{ paddingTop: "80px" }}>
          {formData && <DeliveryChallanKESLayout data={formData} />}
        </div>
      </div>
    </>
  );
...
export default DeliveryChallanKES;
