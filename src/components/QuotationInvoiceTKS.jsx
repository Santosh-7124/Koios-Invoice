...
function QuotationInvoiceTKS() {
  ...
  const [includeQuantity, setIncludeQuantity] = useState("includeQuantity");

  const handleRadioChange = (event) => {
    setIncludeQuantity(event.target.value);
  };
  ...
  const handleRemoveItemNew = (index) => {
    const updatedItemsNew = [...itemsNew];
    updatedItemsNew.splice(index, 1);
    setItemsNew(updatedItemsNew);
  };

  const handleItemChangeNew = (index, event) => {
    const { name, value, type, checked } = event.target;
    const updatedItemsNew = [...itemsNew];

    if (type === "checkbox" && name === "complimentary") {
      updatedItemsNew[index][name] = checked;
      if (checked) {
        updatedItemsNew[index].Quantity = "0";
        updatedItemsNew[index].Cost = "0";
      }
    } else {
      updatedItemsNew[index][name] = value;
    }
    setItemsNew(updatedItemsNew);
  };
  return (
      ...
      <div>
        ...
        <form id="PurchaseKES" name="PurchaseKES" onSubmit={handleSubmit}>
          <div className="formContainer">
            ...
            <div className="formSection">
              <div className="formSectionHeading">Table Type</div>
              <div className="formRadioSection">
                <div className="formInputDiv">
                  <input
                    ...
                    checked={includeQuantity === "includeQuantity"}
                    onChange={handleRadioChange}
                  />
                  <label htmlFor="includeQuantity">Include Quantity</label>
                </div>
                <div className="formInputDiv">
                  <input
                    type="radio"
                    id="notIncludeQuantity"
                    name="quantity"
                    value="notIncludeQuantity"
                    checked={includeQuantity === "notIncludeQuantity"}
                    onChange={handleRadioChange}
                  />
                  <label htmlFor="notIncludeQuantity">
                      ...
                      >
                        ...
                        >
                          ...
                          <div
                            className="formDeleteItem"
                            onClick={() =>
                              handleRemoveDetail(index, detailIndex)
                            }
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
            ...
            {includeQuantity === "notIncludeQuantity" && (
              <div className="formSection">
                <div className="formSectionHeading">Items</div>
                {itemsNew.map((itemNew, index) => (
                  <div className="formItems" key={index}>
                    ...
                    >
                      <div className="formInputDiv">
                        ...
                        <input
                          ...
                          id={`partName${index}`}
                          name="partName"
                          value={itemNew.partName}
                          onChange={(e) => handleItemChangeNew(index, e)}
                        />
                      </div>
                      <div
                        className="formDeleteItem"
                        onClick={() => handleRemoveItemNew(index)}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                    ...
                    <div className="formCheckBox Complimentary">
                      ...
                      <input
                        ...
                        name="complimentary"
                        checked={itemNew.complimentary}
                        onChange={(e) => handleItemChangeNew(index, e)}
                      />
                    </div>
                  </div>
                ))}
                <div className="formAddItem" onClick={handleAddItemNew}>
                ...
                >
                  <div className="formInputDiv">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleTermsChange(termsconditionIndex, e)
                      }
                    />
                  </div>
                  <div
